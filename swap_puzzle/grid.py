...
class Grid():
    ...
    def de_hashage_a_grille(grille):
        grille2=grille.split('n') #On enlève les n
        l=[]
        k=[]
        ...
        for i in grille2:
            ...
            if i=='/':
                ...
                if i[0]=='/': #Quand on a splité par n, certains nombres 'k' deviennent '/k' donc il faut pouvoir accéder à k en resplitant par / cette fois 
                    l.append(k)
                    k=[]
